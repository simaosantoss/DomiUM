...
public class ConsoleView {
    ...
    public void mostrarMenuPrincipal() {
        ...
        System.out.println("3. Gerir permissões");
        System.out.println("4. Criar casa");
        System.out.println("5. Listar casas");
        System.out.println("6. Consultar casa");
        System.out.println("7. Adicionar divisão");
        System.out.println("8. Consultar divisão");
        System.out.println("9. Atualizar ambiente de divisão");
        System.out.println("10. Adicionar dispositivo");
        System.out.println("11. Remover dispositivo");
        System.out.println("12. Ligar dispositivo");
        System.out.println("13. Desligar dispositivo");
        System.out.println("14. Consultar dispositivo");
        System.out.println("15. Listar todos os dispositivos de uma casa");
        System.out.println("16. Operações de dispositivos");
        System.out.println("17. Menu de cenários");
        System.out.println("18. Menu de automações");
        System.out.println("19. Menu de escalonamentos");
        System.out.println("20. Menu de estatísticas");
        System.out.println("21. Menu de sugestões");
        System.out.println("22. Guardar estado");
        System.out.println("23. Carregar estado");
        System.out.println("24. Consultar data/hora atual");
        System.out.println("25. Avançar tempo");

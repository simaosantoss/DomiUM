...
/**
 * Condição baseada na humidade interior de uma divisão.
 */
public class CondicaoHumidade implements Condicao {
    ...
    /**
     * Cria uma condição de humidade.
     *
     * @param limite limite de comparação
     * @param maiorQue {@code true} para testar se a humidade é superior ao
     *                 limite; {@code false} para testar se é inferior
     */
    public CondicaoHumidade(double limite, boolean maiorQue) {
        this.limite = limite;
    ...
    /**
     * Avalia a humidade do ambiente indicado.
     *
    ...
    public boolean avaliar(AmbienteInterior ambiente) {
        ...
        if (this.maiorQue) {
            return ambiente.getHumidade() > this.limite;
        }
        return ambiente.getHumidade() < this.limite;
    }
    ...
    public boolean equals(Object o) {
        ...
        CondicaoHumidade that = (CondicaoHumidade) o;
     ...
     */
    @Override
    public CondicaoHumidade clone() {
        return new CondicaoHumidade(this.limite, this.maiorQue);
    }
}
